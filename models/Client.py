...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.w_trans = torch.nn.Parameter(torch.FloatTensor([configs.w_trans]*configs.enc_in),requires_grad=True)
        self.w_lin = torch.nn.Parameter(torch.FloatTensor([configs.w_lin] * configs.enc_in), requires_grad=True)
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec,
        ...
        dec_out = self.revin_layer(self.w_trans*dec_out[:, -self.pred_len:, :]+self.w_lin*linear_out, 'denorm')
